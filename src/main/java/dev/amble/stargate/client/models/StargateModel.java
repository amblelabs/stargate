...
public class StargateModel extends BaseStargateModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r28 = OuterRing.addChild("cube_r28", ModelPartBuilder.create().uv(0, 16).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.25F))
				.uv(0, 0).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));

		ModelPartData cube_r29 = OuterRing.addChild("cube_r29", ModelPartBuilder.create().uv(0, 52).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6981F));

		ModelPartData cube_r30 = OuterRing.addChild("cube_r30", ModelPartBuilder.create().uv(0, 16).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.25F))
				.uv(0, 0).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0472F));

		ModelPartData cube_r31 = OuterRing.addChild("cube_r31", ModelPartBuilder.create().uv(0, 52).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.3963F));

		ModelPartData cube_r32 = OuterRing.addChild("cube_r32", ModelPartBuilder.create().uv(0, 16).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.25F))
				.uv(0, 0).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));

		ModelPartData cube_r33 = OuterRing.addChild("cube_r33", ModelPartBuilder.create().uv(0, 52).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.0944F));

		ModelPartData cube_r34 = OuterRing.addChild("cube_r34", ModelPartBuilder.create().uv(0, 16).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.25F))
				.uv(0, 0).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.4435F));

		ModelPartData cube_r35 = OuterRing.addChild("cube_r35", ModelPartBuilder.create().uv(0, 52).cuboid(-10.0F, 50.0F, -4.5F, 20.0F, 6.0F, 9.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.7925F));
		...
		ModelPartData cube_r36 = chev8.addChild("cube_r36", ModelPartBuilder.create().uv(0, 32).cuboid(-10.0F, 46.0F, -4.5F, 20.0F, 10.0F, 9.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.7925F));

		ModelPartData chev9 = OuterRing.addChild("chev9", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r37 = chev9.addChild("cube_r37", ModelPartBuilder.create().uv(0, 32).cuboid(-10.0F, 46.0F, -4.5F, 20.0F, 10.0F, 9.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.7925F));
		...
		ModelPartData cube_r38 = chev_light8.addChild("cube_r38", ModelPartBuilder.create().uv(70, 109).cuboid(-10.0F, 46.0F, -4.5F, 20.0F, 10.0F, 9.0F, new Dilation(0.255F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.7925F));

		ModelPartData chev_light9 = lights.addChild("chev_light9", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r39 = chev_light9.addChild("cube_r39", ModelPartBuilder.create().uv(70, 109).cuboid(-10.0F, 46.0F, -4.5F, 20.0F, 10.0F, 9.0F, new Dilation(0.255F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.7925F));

		ModelPartData SymbolRing = stargate.addChild("SymbolRing", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r40 = SymbolRing.addChild("cube_r40", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.618F));

		ModelPartData cube_r41 = SymbolRing.addChild("cube_r41", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.9671F));

		ModelPartData cube_r42 = SymbolRing.addChild("cube_r42", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.7925F));

		ModelPartData cube_r43 = SymbolRing.addChild("cube_r43", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.4435F));

		ModelPartData cube_r44 = SymbolRing.addChild("cube_r44", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.9199F));

		ModelPartData cube_r45 = SymbolRing.addChild("cube_r45", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.2689F));

		ModelPartData cube_r46 = SymbolRing.addChild("cube_r46", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.0944F));

		ModelPartData cube_r47 = SymbolRing.addChild("cube_r47", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));

		ModelPartData cube_r48 = SymbolRing.addChild("cube_r48", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.2217F));

		ModelPartData cube_r49 = SymbolRing.addChild("cube_r49", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.5708F));

		ModelPartData cube_r50 = SymbolRing.addChild("cube_r50", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.3963F));

		ModelPartData cube_r51 = SymbolRing.addChild("cube_r51", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0472F));

		ModelPartData cube_r52 = SymbolRing.addChild("cube_r52", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.5236F));

		ModelPartData cube_r53 = SymbolRing.addChild("cube_r53", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.8727F));

		ModelPartData cube_r54 = SymbolRing.addChild("cube_r54", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6981F));

		ModelPartData cube_r55 = SymbolRing.addChild("cube_r55", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));

		ModelPartData cube_r56 = SymbolRing.addChild("cube_r56", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		ModelPartData cube_r57 = SymbolRing.addChild("cube_r57", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		ModelPartData cube_r58 = SymbolRing.addChild("cube_r58", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3491F));

		ModelPartData cube_r59 = SymbolRing.addChild("cube_r59", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.8727F));

		ModelPartData cube_r60 = SymbolRing.addChild("cube_r60", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.5236F));

		ModelPartData cube_r61 = SymbolRing.addChild("cube_r61", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6981F));

		ModelPartData cube_r62 = SymbolRing.addChild("cube_r62", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.0472F));

		ModelPartData cube_r63 = SymbolRing.addChild("cube_r63", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		ModelPartData cube_r64 = SymbolRing.addChild("cube_r64", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.2217F));

		ModelPartData cube_r65 = SymbolRing.addChild("cube_r65", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.3963F));

		ModelPartData cube_r66 = SymbolRing.addChild("cube_r66", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.7453F));

		ModelPartData cube_r67 = SymbolRing.addChild("cube_r67", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.2689F));

		ModelPartData cube_r68 = SymbolRing.addChild("cube_r68", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.9199F));

		ModelPartData cube_r69 = SymbolRing.addChild("cube_r69", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.0944F));

		ModelPartData cube_r70 = SymbolRing.addChild("cube_r70", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.4435F));

		ModelPartData cube_r71 = SymbolRing.addChild("cube_r71", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.618F));

		ModelPartData cube_r72 = SymbolRing.addChild("cube_r72", ModelPartBuilder.create().uv(59, 18).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.9671F));

		ModelPartData cube_r73 = SymbolRing.addChild("cube_r73", ModelPartBuilder.create().uv(59, 0).cuboid(-9.5F, 42.0F, -3.5F, 19.0F, 10.0F, 7.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -2.7925F));
