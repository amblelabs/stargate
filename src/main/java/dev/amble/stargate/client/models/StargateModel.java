...
public class StargateModel extends BaseStargateModel {
	...
	public final ModelPart chev7mid;
	...
	public final ModelPart destiny;
	public final ModelPart accessorylights;
	public final ModelPart SymbolRing;
	public final ModelPart Extras;
	public final ModelPart Extras2;
	public final ModelPart Base;
	public final ModelPart Base2;
	public final ModelPart BaseLights;
	public final ModelPart BaseLight1;
	public final ModelPart BaseLight2;
	public final ModelPart BaseLight3;
	public final ModelPart BaseLights2;
	public final ModelPart BaseLight4;
	public final ModelPart BaseLight5;
	public final ModelPart BaseLight6;
	public final ModelPart SymbolRingDestiny;
	public final ModelPart DestExtras;
	public final ModelPart DestBase;
	public final ModelPart InnerRing;
	public final ModelPart InnerRingLayer;
	...
	public StargateModel(ModelPart root) {
		...
		this.chev7mid = this.OuterRing.getChild("chev7mid");
		...
		this.main = this.OuterRing.getChild("main");
		this.destiny = this.OuterRing.getChild("destiny");
		this.accessorylights = this.OuterRing.getChild("accessorylights");
		this.SymbolRing = this.stargate.getChild("SymbolRing");
		this.Extras = this.SymbolRing.getChild("Extras");
		this.Extras2 = this.SymbolRing.getChild("Extras2");
		this.Base = this.SymbolRing.getChild("Base");
		this.Base2 = this.SymbolRing.getChild("Base2");
		this.BaseLights = this.SymbolRing.getChild("BaseLights");
		this.BaseLight1 = this.BaseLights.getChild("BaseLight1");
		this.BaseLight2 = this.BaseLights.getChild("BaseLight2");
		this.BaseLight3 = this.BaseLights.getChild("BaseLight3");
		this.BaseLights2 = this.SymbolRing.getChild("BaseLights2");
		this.BaseLight4 = this.BaseLights2.getChild("BaseLight4");
		this.BaseLight5 = this.BaseLights2.getChild("BaseLight5");
		this.BaseLight6 = this.BaseLights2.getChild("BaseLight6");
		this.SymbolRingDestiny = this.stargate.getChild("SymbolRingDestiny");
		this.DestExtras = this.SymbolRingDestiny.getChild("DestExtras");
		this.DestBase = this.SymbolRingDestiny.getChild("DestBase");
		this.InnerRing = this.stargate.getChild("InnerRing");
		this.InnerRingLayer = this.InnerRing.getChild("InnerRingLayer");
