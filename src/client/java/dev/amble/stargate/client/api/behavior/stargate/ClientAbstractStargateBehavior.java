...
> implements
    ...
    public boolean updateChevronVisibility(
        ...
        for (int i = 0; i < chevrons.length; i++) {
            if (chevrons[i] != null) chevrons[i].visible =
                visible || i < locked;
        }
        ...
        public static float renderGlyphs(
            ...
            if (shouldRenderGlyphs(client, gate)) {
                ...
                if (closed != null && closed.locking) {
                    ...
                    float selectedRot = MathHelper.wrapDegrees(
                ...
                for (int i = 0; i < MAX_GLYPHS; i++) {
                    ...
                    matrices.translate(
                        MathHelper.sin(angle) * 117,
                        MathHelper.cos(angle) * 117,
                        0
                    );

                    // rotate the symbols towards the gate
                    matrices.multiply(
                        RotationAxis.NEGATIVE_Z.rotationDegrees(
